  ...
  >
    <div className="text-[40px] xs1167:text-[57px] xs1700:text-[72px] flex flex-col gap-[10px] text-primary max-w-[650px]">
      <p className="leading-[1] text-center font-semibold">
        Discover <span className="text-op1">the</span> Quran{" "} <br />
    ...
    <p className="text-op2 font-medium  text-[15px] xs1167:text-[20px] xs1700:text-[24px] max-w-[534px] text-center mt-[20px] leading-[1.3]">
      Memorize more effectively with the help of our tools and <br className='xs1500:hidden' /> deepen your knowledge in theory
    </p>
    <div className="flex mt-[32px] gap-[16px] text-[22px]">
      <div className="relative inline-block h-max rounded-[22px] overflow-hidden">
        <button className="relative px-[25px] py-[15px] xs1700:px-[32px] xs1700:py-[20px] cursor-pointer outline-none rounded-[22px] text-white bg-gradient-to-b from-[#90C6B6] to-[#7BAF9D]">
      ...
      <button className="px-[25px] py-[15px] xs1700:px-[32px] xs1700:py-[20px]
        border-[2px] border-[#E4E4E4] cursor-pointer outline-none rounded-[22px]">Read more</button>
    </div>
  </motion.div>
);